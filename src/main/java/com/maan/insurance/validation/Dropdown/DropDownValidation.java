...
//		}
	...
	public List<ErrorCheck> getProductieModuleDropDown(GetProductieModuleDropDownReq req) {
		List<ErrorCheck> list = new ArrayList<ErrorCheck>();
	...
	public List<ErrorCheck> setTerritoryCountryListVali(SetTerritoryCountryListReq req) {
		List<ErrorCheck> list = new ArrayList<ErrorCheck>();
		if (StringUtils.isBlank(req.getBranchCode())) {
			list.add(new ErrorCheck("Please Enter BranchCode", "BranchCode", "1"));
		}
		if (CollectionUtils.isEmpty(req.getCountryExclude())) {
			list.add(new ErrorCheck("Please Enter CountryExclude", "CountryExclude", "2"));
		}
		if (CollectionUtils.isEmpty(req.getTerritoryId())) {
			list.add(new ErrorCheck("Please Enter TerritoryId", "TerritoryId", "3"));
		}
		if (StringUtils.isBlank(req.getType())) {
			list.add(new ErrorCheck("Please Enter Type", "Type", "4"));
		}
	...
	public List<ErrorCheck> getExcludeCountryVali(GetExcludeCountryReq req) {
		List<ErrorCheck> list = new ArrayList<ErrorCheck>();
		if (StringUtils.isBlank(req.getBranchCode())) {
			list.add(new ErrorCheck("Please Enter BranchCode", "BranchCode", "1"));
		}
		...
		if (StringUtils.isBlank(req.getCountryMode())) {
			list.add(new ErrorCheck("Please Enter CountryMode", "CountryMode", "4"));
		}
		return list;
	}
