...
public class FacPremiumValidation {
	...
	public List<ErrorCheck> premiumEditVali(PremiumEditReq req) {
		...
		if (StringUtils.isBlank(req.getCountryId())) {
			list.add(new ErrorCheck("Please Enter CountryId", "OpendDate", "3"));
		}
		if (StringUtils.isBlank(req.getGwpiOS())) {
			list.add(new ErrorCheck("Please Enter GwpiOS", "OpstartDate", "4"));
		}
...
//		}
		...
		if (StringUtils.isBlank(req.getRdsExchageRate())) {
			list.add(new ErrorCheck("Please Enter RdsExchageRate", "OpstartDate", "8"));
		}
		if (StringUtils.isBlank(req.getTableType())) {
			list.add(new ErrorCheck("Please Enter TableType", "ContractNo", "9"));
		}
		if("Edit".equalsIgnoreCase(req.getMode())) {
		if (StringUtils.isBlank(req.getRequestNo())) {
			list.add(new ErrorCheck("Please Enter RequestNo", "OpendDate", "10"));
		}
		}else {
		if (StringUtils.isBlank(req.getTransactionNo())) {
			list.add(new ErrorCheck("Please Enter TransactionNo", "OpstartDate", "12"));
		}
		}
...
//			list.add(new ErrorCheck("Please Enter TransDropDownVal", "TransDropDownVal", "13"));
//		}
		return list;
	}
