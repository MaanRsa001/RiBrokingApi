...
//		}
	...
	public CommonResponse updateRenewalEditMode(@RequestBody updateSubEditModeReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getProductieModuleDropDown(@RequestBody GetProductieModuleDropDownReq req) throws CommonValidationException {
...
public GetCommonDropDownRes getDeptName(@PathVariable("branchCode") String branchCode) throws CommonValidationException{
	return dropDownservice.getDeptName(branchCode);
}


		@GetMapping("/updateBaseLayer/{baseLayer}/{proposalNo}")
		public CommonResponse updateBaseLayer(@PathVariable ("baseLayer") String baseLayer,@PathVariable ("proposalNo") String proposalNo) throws CommonValidationException {
		return dropDownservice.updateBaseLayer(baseLayer,proposalNo);
			}  
		@GetMapping("/getPaymentPartnerlist/{branchCode}/{cedingId}/{brokerId}")
			public GetCommonDropDownRes getPaymentPartnerlist(@PathVariable ("branchCode") String branchCode,@PathVariable ("cedingId") String cedingId,@PathVariable ("brokerId") String brokerId) throws CommonValidationException {
			...
			@GetMapping("/updateProposalno/{referenceNo}/{proposalNo}")
				public CommonResponse updateProposalno(@PathVariable ("referenceNo") String referenceNo,@PathVariable ("proposalNo") String proposalNo) throws CommonValidationException {
				return dropDownservice.updateProposalno(referenceNo,proposalNo);
					}  
				@GetMapping("/getBouquetList/{branchCode}")
					public GetBouquetListRes getBouquetList(@PathVariable ("branchCode") String branchCode) throws CommonValidationException {
