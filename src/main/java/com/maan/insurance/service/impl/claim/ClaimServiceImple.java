...
//		    		res.setUpdatedDate(data.get("UPDATED_DT")== null?"":data.get("UPDATED_DT").toString());
		    		res.setCurrecny(data.get("CURRENCY")== null?"":data.get("CURRENCY").toString());
...
//  				query=getQuery(DBConstants.CLAIM_SELECT_LOSSESTIMATEREVISEDOC);
				log.info("Select Query====>"+list);
//				log.info("Arg[0]====>"+req.getClaim_No());
//				log.info("Arg[1]====>"+req.getPolicy_Contract_No());
//				LOGGER.info("Arg[2]====>"+req.getClaim_No());
//				LOGGER.info("Arg[3]====>"+req.getPolicy_Contract_No());
//				req.setLoss_Estimate_Revised_Orig_Curr((String)this.mytemplate.queryForObject(query,new Object[]{req.getClaim_No(),req.getPolicy_Contract_No(),req.getClaim_No(),req.getPolicy_Contract_No()},String.class));
  		finalList.add(res);
		response.setCommonResponse(finalList);
	}catch (Exception e) {
		log.error(e);
...
//				LOGGER.info("Arg[0]====>"+req.getClaim_No());
//				LOGGER.info("Arg[1]====>"+req.getPolicy_Contract_No());
//				LOGGER.info("Arg[2]====>"+req.getClaim_No());
//				LOGGER.info("Arg[3]====>"+req.getPolicy_Contract_No());
//				
//				req.setLoss_Estimate_Revised_Orig_Curr((String)this.mytemplate.queryForObject(query,new Object[]{req.getClaim_No(),req.getPolicy_Contract_No(),req.getClaim_No(),req.getPolicy_Contract_No()},String.class));
//				
//				LOGGER.info("Result ==>"+req.getLoss_Estimate_Orig_Curr());
			}
